            ...
            <Form onSubmit={(e) => this.handleSubmit(e)}>
                ...
                <FormItem {...formItemLayout} label="id">
                    {getFieldDecorator("id", {
                        initialValue: customer.id, rules: [],
                    })(<Input disabled={true}/>)}
                </FormItem>
                <FormItem {...formItemLayout} label="name">
                    {getFieldDecorator("username", {
                        initialValue: customer.username, rules: [
...
export default connect(mapStateToProps, mapDispatchToProps, undefined, {pure: false})(CustomerEditFrom)
